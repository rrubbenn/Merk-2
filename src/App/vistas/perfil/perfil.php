...
<div class="container">
    <div class="row mt-4 d-flex align-items-center">
        <div class="col-6 d-flex align-items-center">
            ...
            <img src="<?php echo isset($datos['datosUsuario']->imagen_perfil) && $datos['datosUsuario']->imagen_perfil 
            ? RUTA_URL_STATIC . '/imgbase/' . $datos['datosUsuario']->imagen_perfil 
            : RUTA_URL_STATIC . '/img/default.jpg'; ?>" class="card-img-top" id="imagenes" alt="Imagen de perfil">
            </div>
    ...
    <div class="row mt-2 Vendidos d-none" id="Vendidos">
        <div class="col-12">
            <?php foreach ($datos['Vendidos'] as $producto): ?>
                <a href="<?php echo RUTA_URL?>/productos/producto/<?php echo $producto->id_producto?>" class="row text-decoration-none text-dark mt-1">
                    <div class="col-3 col-md-2">
                        <img src="<?php echo RUTA_URL_STATIC ?>/imgbase/<?php echo $producto->ruta ?>" class="card-img-top imgproductoperfil"  id="imagenes"> </img>
                    </div>
                    <div class="col-2 col-md-2 pt-2 pt-sm-0 d-flex align-items-center">
                        <p class="p-0 mb-0"> <?php echo $producto->nombre_producto ?> </p>
                    </div>
                    ...
                    <div class="col-3 col-md-4 pt-2 pt-sm-0 d-none d-md-flex align-items-center">
                        <p class="p-0 mb-0"> <?php echo $producto->descripcion ?> </p>
                    </div>
                    <div class="col-3 col-md-2 pt-2 pt-sm-0 d-flex align-items-center">
                        <p class="p-0 mb-0"> <u> Mas Información... </u> </p>
                    </div>
                </a>
            <?php endforeach ?>
