        ...
        <div class="d-flex flex-wrap"> 
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <div class="col-12 col-md-10 offset-md-1 d-flex flex-wrap justify-content-center">
                    <img class="mt-3 mb-5 imgperfil col-12 justify-content-center" 
                    src="<?php echo isset($datos['datosUsuario']->imagen_perfil) && $datos['datosUsuario']->imagen_perfil 
                        ? RUTA_URL_STATIC . '/imgbase/' . $datos['datosUsuario']->imagen_perfil 
                        : RUTA_URL_STATIC . '/img/default.jpg'; ?>" alt=""></img>
